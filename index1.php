...
<html lang="en">
  ...
  <body style="background: #F0F2F0;background: -webkit-linear-gradient(to bottom, #674EA7, #F0F2F0);background: linear-gradient(to bottom, #674EA7, #F0F2F0); background-size: cover;">
    <nav class="navbar navbar-expand-lg navbar-dark fixed-top" id="mainNav" >
    <div class="container">

      <a class="navbar-brand js-scroll-trigger" href="index.php" style="margin-top: 10px;margin-left:-65px;font-family: 'IBM Plex Sans', sans-serif;"><h4><i class="fa fa-hospital-o" aria-hidden="true"></i>&nbsp Fix a Date-Meet your Doctor</h4></a>
    ...
    animation: mover 1s infinite alternate;">
          <img src="images/cal.jpg" alt="" style="width: 30%;padding-left: 40px;margin-top: 150px;margin-left: 45px;margin-bottom:15px;border-radius:50%">
      </div>

      <div style="color: white;">
            <h4 style="font-family: 'IBM Plex Sans', sans-serif; margin-left: 40px"> Book your Appointment</h4>
          </div>
