...
include('func.php');  
include('newfunc.php');
$con=mysqli_connect("localhost","root","","hospitalms"); //database connect
...
if(isset($_GET["generate_bill"])){
  ...
  $content .= '
      <br/>
      <h2 align ="center"> Fix a Date-Meet your Doctor</h2></br>
      <h3 align ="center"> Prescription Bill</h3>
  ';
...
<html lang="en">
  ...
  <a class="navbar-brand" href="#"><i class="fa fa-hospital-o" aria-hidden="true"></i> Fix a Date-Meet your Doctor</a>
  ...
  <style >
    ...
    background: -webkit-linear-gradient(to right, #674EA7, #F0F2F0);  /* Chrome 10-25, Safari 5.1-6 */
    background: linear-gradient(to right, #674EA7, #F0F2F0); /* W3C, IE 10+/ Edge, Firefox 16+, Chrome 26+, Opera 12+, Safari 7+ */
...
.list-group-item.active {
    ...
    color: #fff;
    background: #F0F2F0; 
    background: -webkit-linear-gradient(to right, #674EA7, #F0F2F0);
    background: linear-gradient(to right, #674EA7, #F0F2F0);
    border-color: #c3c3c3;
}
.text-primary {
